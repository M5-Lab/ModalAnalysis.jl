...
function MonteCarloJob(sys::SuperCellSystem{D}, TEP_path::String,
     n_steps::Int, n_steps_equil::Int, step_size_std, outpath::String, temp, kB, data_interval;
    ...
    U_arr, num_accepted = runMC(sys, TEP_path, sim, outpath, output_type, data_interval;
                                F2_name = F2_name, F3_name = F3_name)
